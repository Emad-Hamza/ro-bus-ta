...
class FillPermissionsForStationsTrip extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStationsTrip constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.stations-trip',
            'admin.stations-trip.index',
            'admin.stations-trip.create',
            'admin.stations-trip.show',
            'admin.stations-trip.edit',
            'admin.stations-trip.delete',
            'admin.stations-trip.bulk-delete',
        ]);
